...
const deleteBucketFinalizerName = "deletebucket.finalizers.rafter.kyma-project.io"
...
// +kubebuilder:rbac:groups=rafter.kyma-project.io,resources=buckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rafter.kyma-project.io,resources=buckets/status,verbs=get;update;patch
...
func (r *BucketReconciler) appendFinalizer(ctx context.Context, namespacedName types.NamespacedName) error {
	updateFnc := func(instance *assetstorev1beta1.Bucket) error {
...
func (r *BucketReconciler) updateStatus(ctx context.Context, namespacedName types.NamespacedName, commonStatus *assetstorev1beta1.CommonBucketStatus) error {
	updateFnc := func(instance *assetstorev1beta1.Bucket) error {
...
func (r *BucketReconciler) isStatusUnchanged(instance *assetstorev1beta1.Bucket, newStatus *assetstorev1beta1.CommonBucketStatus) bool {
...
func (r *BucketReconciler) update(ctx context.Context, namespacedName types.NamespacedName, updateFnc func(instance *assetstorev1beta1.Bucket) error) error {
