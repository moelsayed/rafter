...
var _ = Describe("Bucket", func() {
	var (
		bucket     *assetstorev1beta1.Bucket
...
func newFixBucket() *assetstorev1beta1.Bucket {
	return &assetstorev1beta1.Bucket{
		ObjectMeta: ctrl.ObjectMeta{
			Name:      string(uuid.NewUUID()),
			Namespace: "default",
		},
		Spec: assetstorev1beta1.BucketSpec{
		...
		Status: assetstorev1beta1.BucketStatus{CommonBucketStatus: assetstorev1beta1.CommonBucketStatus{
