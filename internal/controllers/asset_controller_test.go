...
func newFixAsset(bucketName string) *assetstorev1beta1.Asset {
	return &assetstorev1beta1.Asset{
		ObjectMeta: ctrl.ObjectMeta{
			Name:      string(uuid.NewUUID()),
			Namespace: "default",
		},
		Spec: assetstorev1beta1.AssetSpec{
		...
		Status: assetstorev1beta1.AssetStatus{CommonAssetStatus: assetstorev1beta1.CommonAssetStatus{
